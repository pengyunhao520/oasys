...
<div class="row" style="padding-top: 15px;">
    <div class="col-md-12">
        <!--id="container"-->
        <div class="bgc-w box">
            <form action="unitedit" method="post" onsubmit="return check();">
                <#--判断unit是否为空-->
                <#if unit??>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="phone" class="form-control" value="${(unit.phone)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>地址</span></label>
                                <input name="address" class="form-control" value="${(unit.address)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>邮箱</span></label>
                                <input name="email" class="form-control" value="${(unit.email)!''}"/>
                            </div>

                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>邮编</span></label>
                                <input name="postalcode" class="form-control" value="${(unit.postalcode)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>网址</span></label>
                                <input name="website" class="form-control" value="${(unit.website)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>银行卡号</span></label>
                                <input name="banknuber" class="form-control" value="${(unit.banknuber)!''}"/>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="control-label"><span>开户行</span></label>
                                <input name="openingbank" class="form-control" value="${(unit.openingbank)!''}"/>
                            </div>
